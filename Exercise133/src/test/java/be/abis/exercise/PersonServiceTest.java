...
public class PersonServiceTest {
	...
	@Test
	@Order(10)
	public void addingAnnAgainThrowsException() {
		PersonForm p = new PersonForm("ANN","DE KEYSER",LocalDate.of(1982,02,02),"ann.dekeyser@abis.be","blabla","NL");
		Throwable ex =assertThrows(RuntimeException.class, ()-> personService.addPerson(p).block());
	...
	@Test
	@Order(11)
	public void personByEmailIsJohn(){
		assertEquals("JOHN", personService.findPersonByEmail("john.doe@gmail.com").block().getFirstName());
	}
