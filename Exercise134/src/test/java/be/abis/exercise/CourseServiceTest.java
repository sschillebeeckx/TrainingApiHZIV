...
/*	@Test
	@Transactional
	public void addCourseNotAuthenticated() {
		Course c = new Course("SPRINGJPA","Using JPA with Spring Boot",3,525.0);
		Throwable ex = assertThrows(RuntimeException.class, ()->courseService.addCourse(c).block());
 ...
 */
	...
	public void deleteNotAuthorized() {
		Throwable ex= assertThrows(RuntimeException.class, ()->courseService.deleteCourse(8055).block());
		assertTrue(ex.getCause() instanceof NotAuthorizedException);
	}
