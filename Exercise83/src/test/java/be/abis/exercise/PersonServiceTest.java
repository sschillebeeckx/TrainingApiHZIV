...
class PersonServiceTest {
    ...
    @Test
    @Order(9)
    public void addingPersonWithTooShortPWDThrowsException() {
        Person p = new Person(20,"An","Doe", DateUtils.parse("12/11/2005"),"adoe@abis.be","some","nl",c);
    ...
    public void addingJohnAgainThrowsException() {
        Person jAgain = new Person(20,"Jef","Doe", DateUtils.parse("12/11/2005"),"jdoe@abis.be","somepwd","nl",c);
