...
public class PersonApiController {
    ...
    @PostMapping(path="")
    public Mono<Person> addPerson(@RequestBody Person p) throws PersonAlreadyExistsException {
    ...
    @PutMapping("{id}")
    public Mono<Person> changePassword(@PathVariable("id") int id, @RequestBody Person person) throws PersonNotFoundException {
